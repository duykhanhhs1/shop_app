        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(child: Text('STT', style: tableTextTitle), flex: 1),
                  Expanded(
                      child: Text('Khách hàng', style: tableTextTitle),
                      flex: 4),
                  Expanded(
                      child: Text('Số tiền (₫)', style: tableTextTitle),
                      flex: 3),
                  Expanded(
                      child: Text('Thời gian', style: tableTextTitle), flex: 2),
                ],
              ),
            ),
            ListView.builder(
  ...
  Widget _buildLineStatistic(
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          '₫${NumberHelper.currencyFormat(price)}',
          style: TextStyle(color: kWhiteTextColor),
        )
      ],
    );
